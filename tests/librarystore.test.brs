...
sub Test_Library_AddAndListSaved()
    ...
    Harness_Ok(store.AddSaved("tt0133093", "movie", "The Matrix", "poster.png", "logo.png"), "add second")
    ...
    Harness_Equal(items[0].logo, "logo.png", "logo carried")
...
sub Test_Library_ContinueWatchingOrdering()
    ...
    store.SetPosition("tt1234567:1:1", "tt1234567", "series", 1, 1, "Pilot", "https://img.png", "logo.png", 90, 1800)
    ...
    Harness_Equal(list[0].logo, "logo.png", "logo carried")
